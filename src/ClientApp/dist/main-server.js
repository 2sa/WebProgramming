...
(function (global, factory) {
     true ? factory(exports, __webpack_require__(1), __webpack_require__(26), __webpack_require__(35), __webpack_require__(32), __webpack_require__(33)) :
...
var SongsService_1 = __webpack_require__(12);
var player_component_1 = __webpack_require__(14);
var playlist_component_1 = __webpack_require__(15);
var songlist_component_1 = __webpack_require__(16);
    ...
    core_1.NgModule({
        ...
        imports: [
            ...
            router_1.RouterModule.forRoot([
                ...
                { path: 'home', component: player_component_1.PlayerComponent },
                { path: '**', redirectTo: 'home' }
            ])
        ],
        providers: [
            { provide: common_1.APP_BASE_HREF, useValue: '/' },
            SongsService_1.SongsService
        ]
    })
], AppModule);
...
var SongsService = (function () {
    ...
    SongsService.prototype.loadSongs = function () {
        var _this = this;
        this.http.get('/api/songs/allsongs').subscribe(function (res) { _this._songs = res.json(); });
    };
    return SongsService;
}());
...
var SongUrl = (function () {
    function SongUrl() {
    }
    return SongUrl;
}());
exports.SongUrl = SongUrl;
var PlaylistTrackDescription = (function () {
    function PlaylistTrackDescription(pos, track, isActive) {
        this.pos = pos;
        this.track = track;
        this.isActive = isActive;
    }
    return PlaylistTrackDescription;
}());
exports.PlaylistTrackDescription = PlaylistTrackDescription;
var TrackDescription = (function () {
    function TrackDescription() {
    }
    return TrackDescription;
}());
exports.TrackDescription = TrackDescription;
...
var PlayerComponent = (function () {
    function PlayerComponent(formBuilder) {
        this.formBuilder = formBuilder;
        this.playListSongs = new Array();
        this.playlistSongId = 0;
        this.inPlay = 0;
        this.isActive = false;
        this.allSongs = [
            {
    ...
    PlayerComponent.prototype.search = function (value) {
        var _this = this;
        console.log(value);
        if (value === "") {
            this.songs = this.allSongs;
            ...
            this.songs =
                this.allSongs.filter(function (item) {
                    var fullString = item.artist + " " + item.song + " " + item.album + " " + item.year;
                    return _this.findSubstring(fullString, value);
                });
        }
    };
    PlayerComponent.prototype.findSubstring = function (where, what) {
        return where.toLocaleLowerCase().indexOf(what.toLocaleLowerCase()) >= 0;
    };
    PlayerComponent.prototype.songAdded = function (song) {
        this.playListSongs.push(song);
    };
    PlayerComponent.prototype.songDeleted = function (idx) {
        this.deleteSongFromPlayList(idx);
    };
    PlayerComponent.prototype.playlistAddSong = function (song) {
        this.playListSongs.push({ track: song, pos: ++this.playlistSongId, isActive: false });
    };
    PlayerComponent.prototype.updatePlayer = function (idx) {
        var _this = this;
        if (idx === -1) {
            this.isActive = false;
            this.inPlay = idx;
        }
        this.playListSongs.forEach(function (element) {
            if (element.pos === idx) {
                _this.inPlay = idx;
                _this.isActive = true;
                _this.songForPlay = element;
                _this.songForPlay.isActive = true;
            }
        });
    };
    PlayerComponent.prototype.deleteSongFromPlayList = function (idx) {
        this.playListSongs.splice(idx, 1);
    };
    PlayerComponent.prototype.onPlayEnded = function () {
...
var PlayListComponent = (function () {
    function PlayListComponent() {
        this.onSongDelete = new core_1.EventEmitter();
        this.onSongChange = new core_1.EventEmitter();
    }
    PlayListComponent.prototype.togglePlay = function (song) {
        var _this = this;
        this.songs.forEach(function (element) {
            ...
            if (element.pos === song.pos) {
                ...
                _this.playingSong = song.pos;
                _this.onSongChange.emit(_this.playingSong);
            }
        });
    };
    PlayListComponent.prototype.songDelete = function (song) {
...
], PlayListComponent.prototype, "songs", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], PlayListComponent.prototype, "onSongDelete", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], PlayListComponent.prototype, "onSongChange", void 0);
...
var SonglistComponent = (function () {
    function SonglistComponent(formBuilder) {
        this.formBuilder = formBuilder;
        this.onSongAddedToPlayList = new core_1.EventEmitter();
        this.currentCount = 0;
        this.searchForm = this.formBuilder.group({
            searchString: ['', forms_1.Validators.required]
        });
    ...
    SonglistComponent.prototype.sortBySongName = function () {
        this.songs.sort(this.compareBySongName);
    };
    SonglistComponent.prototype.compareBySongName = function (first, second) {
    ...
    SonglistComponent.prototype.sortByArtistName = function () {
        this.songs.sort(this.compareByArtistName);
    };
    SonglistComponent.prototype.compareByArtistName = function (first, second) {
...
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], SonglistComponent.prototype, "onSongAddedToPlayList", void 0);
...
// module
exports.push([module.i, ".musiclist li\r\n{\r\n    height:70px;\r\n}\r\n\r\n.musiclist li .badge, .playlist li .badge\r\n{\r\n    background-color: inherit;\r\n    font-size:inherit;\r\n}", ""]);
...
module.exports = "<ul class=\"list-group playlist\">\r\n    <li class=\"list-group-item\" *ngFor=\"let song of songs\">\r\n        <div class=\"input-group playlist-item\">\r\n            <span class=\"input-group-addon\">\r\n                \r\n                    <button (click)=\"songDelete(song)\" href=\"#\" class=\"btn-dots\">\r\n                        <span class=\"glyphicon glyphicon-remove\"></span>\r\n            </button>\r\n\r\n            </span>\r\n            <div class=\"song\" (click)=\"togglePlay(song)\">\r\n                <a href=\"#\">{{song.track.artist}} - {{song.track.song}}</a>\r\n                <div *ngIf=\"song.isActive\" class=\"equalizer\"></div>\r\n            </div>\r\n        </div>\r\n    </li>\r\n</ul>";

/***/ }),
/* 25 */
/***/ (function(module, exports) {

module.exports = "<ul class=\"list-group musiclist\">\r\n    <li class=\"list-group-item\">\r\n        Sort by <button (click)=\"sortByArtistName()\">Artist</button> <button (click)=\"sortBySongName()\">Song</button>\r\n        <span style=\"color:#222222;\" class=\"badge\">\r\n             Songs in playlist: {{ currentCount }}\r\n        </span>\r\n    </li> \r\n\r\n    <li *ngFor=\"let song_ of songs\" class=\"list-group-item\">\r\n\r\n        <span class=\"badge\">\r\n            <button class=\"btn btn-default\" (click)=\"addToPlayList(song_)\">\r\n                <span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\"></span>\r\n            </button>\r\n        </span>\r\n        {{song_.artist}} - {{song_.song}} <br />\r\n            <span style=\"color:#777777; font-size:1.3rem;\">{{song_.album}}, {{song_.year}}</span>\r\n        \r\n    </li>             \r\n</ul>";
